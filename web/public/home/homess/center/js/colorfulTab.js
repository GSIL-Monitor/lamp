  ...
  $.fn.colorfulTab = function(options) {
    ...
    return this.each(function() {
      ...
      if (!settings.backgroundImage == true) {
        ...
        ID.css("background", "linear-gradient( rgba(" + hex2rgb(settings.overlayColor, settings.overlayOpacity) + "), rgba(" + hex2rgb(settings.overlayColor, settings.overlayOpacity) + ") )");
      }
