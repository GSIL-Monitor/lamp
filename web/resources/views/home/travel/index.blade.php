...
<div class="carbg">
			<div class="container">
				<div class="title2">
					<h1><i class="iconfont icon-jingdian"></i>特色主题游</h1>
					<p>最专业的旅行定制专家，为您打造最有价值的旅行！</p>
		...
		<div class="boxleft">
				<div class="piece">
					<ul>
						...
						<li>
							<h1><a href="/home/travel/{{ $v -> id}}"><img src="{{ $pic[$k][0] }}"/></a></h1>
							<h2>{{ $v-> title }}</h2>
							<h3>
								<p><span>目的地</span>{{ $v -> address }}</p>
								<p><span>标签</span>{{ $v -> tag }}</p>
								<p><span>时&nbsp;&nbsp;&nbsp;&nbsp;长</span>{{ $v -> day }}</p>
							</h3>
						</li>
						@endforeach
					</ul>
