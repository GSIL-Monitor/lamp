        ...
        <div class="menu clearfix" style="height:40px">
            <ul class="fontSong">
                ...
                <li data-bn-ipg="usercenter-tab-footprint"  style="width: 120px">
                    <a href="/home/album" class="a_list" style="text-align: center">相册</a>
                </li>
                <li data-bn-ipg="usercenter-tab-thread"  style="width: 120px">
                    <a href="/home/info/shoucang" class="a_list" style="text-align: center" >
                    <strong> 0 </strong> 收藏 </a>
                </li>
                <li data-bn-ipg="usercenter-tab-ask" style="width: 120px" >
                    <a href="/home/info/trash" class="a_list" style="text-align: center">回收站</a>
                </li>
            </ul>
                <a data-bn-ipg="usercenter-profile" href="/home/geren" class="data">设置</a>
        </div>

        <div class="u_ind_travel_btn">
            <a href="/home/bbs/create" class="newbbsthreads_ajax" data-bn-ipg="usercenter-travelnote-new-mid">写新帖</a>
        </div>
                ...
                <div class="linelist" style="background: #F3F6F7">
                    <ul>
                        <li>
                            <div class="hotglleft">
                                <a href=" ">
                                    <img src="{{ $v -> pro }}" style="width: 282px;height: 166px;">
                                </a>
                            </div>
                            <div class="hotglright">
                                ...
                                <h5>
                                    <a href="/home/info/del/{{ $v -> id }}" id="tiez_id">删除</a>
                            ...
                            <script type="text/javascript">
                                $.ajaxSetup({
                                    ...
                                    //点击删除
                                    $('#tiez_id').eq(0).click(function(){
                                        var id = $(this).{{ $v -> id}};
                                        
                                        $.post('/home/info/del',{'id':id},function(msg){
                                            // alert(msg);
                                            if(msg == 'success'){
                                                // 移除选中的节点
                                                $('#tiez_id').parent().parent().parent().parent().parent().parent().parent().remove();
                                            }else{
                                                alert('删除失败');
                                            }
                                        },'html');
