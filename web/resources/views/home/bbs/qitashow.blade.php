...
<div class="u_ind_topbar" >
    <!--用户封面 -->
    <div class="u_ind_banner_fix" style="position:abselute;z-index:-1;">
        <!--用户封面图 -->
        <div class="u_ind_banner" id="u_ind_banner" >
            <div class="img" >
                  <img src="@if(!empty($user -> Usersdetail -> beijingpic)) {{ $user -> Usersdetail -> beijingpic }}@else /home/beijingpic/morenbeijing.png @endif" style="position:abselute;z-index:4;"  />
            </div>
    ...
    <div class="u_ind_head">
        ...
        <div class="infos">
            <h3 class="name">
                ...
                <a href="javascript:void(0);" data-uid="10587925" data-relate="1" data-each="0"  class="ui_attent_btn _js_follow_func" onblur="this.blur();">关注按钮</a>
            
                <a href="javascript:void(0)" data-bn-ipg="usercenter-msg" data-relate="" data-uid="10587925" class="ui_private_btn _jsaddmsg" onblur="this.blur();">留言</a>
            </h3>
            <div class="text fontSong">
                个性签名：<a data-bn-ipg="usercenter-grade" href=" " class="fb cBlue pr20">{{ $user -> Usersdetail -> users_des }}</a>
        ...
        <div class="menu clearfix" style="height:40px">
            <ul class="fontSong">
                <li data-bn-ipg="usercenter-tab-home"  class="current" style="width: 120px">
                ...
                <a data-bn-ipg="usercenter-profile" href="" class="data">设置</a>
        </div>

        <!-- 帖子开始 -->
        @foreach( $user -> Userarticles  as $k => $v )
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="hotglright">
                                ...
                                <h4>
                                    <i class="iconfont icon-ziyouanpai"></i>发表时间：<span>{{ $v -> created_at }}</span>
                                </h4>
                                    <p>
