...
<div class="carbg">
			<div class="container">
				<div class="title2">
					<h1><i class="iconfont icon-jingdian"></i>热门</h1>
					<p>掌握最新热门景点，花最少的钱赏最美的景</p>
				</div>
			</div>
		</div>
		<!--列表头部 end-->
		...
		<div class="container mt10">
			<div class="boxleft">
				<div class="gllist">
					<ul>
						@foreach($scenery as $k=>$v)
						<li>
							<h1><a href="/home/scenery/{{ $v -> id}}"><img src="{{ $v->picture }}"/></a></h1>
		...
		<div class="container">
			...
			<div class="pagination">
          		{!! $scenery->appends($request)->render() !!}
      		</div>
			<!--gg-->
			<div class="gg2">
