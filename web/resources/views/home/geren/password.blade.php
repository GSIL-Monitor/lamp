...
<script src="/home/gerenxiugai/js/profile_js_be72a32eb8daa4ce8cd7ef34b920b054_1.js"></script>
	...
	<div class="u_set_cnt clearfix">
	    ...
	    <ul>
	        <li data-bn-ipg="usercenter-setting-password"  class="current">
	    ...
	    <div class="u_set_main">
	        ...
	        <!--设置模块栏目内容 -->
	     	<div class="u_set_pass">
	        	<form action="/home/geren/{{ $user -> id }}/updatepassword" method="post"  id="passwordform" onsubmit="return false">
	            	{{ csrf_field() }}
	          		<!-- {{ method_field('POST') }} -->
	                <ul class="clearfix">
	                    <li>
        ...
        $.ajax({
           ...
           success: function(res){
              if(res.error == 0){
                  tips.show(res.msg);
                setTimeout(function (){
                  window.location.href='https://passport.qyer.com/logout';
                }, 3000);
              }else{
