...
<script src="/home/gerenxiugai/js/profile_js_be72a32eb8daa4ce8cd7ef34b920b054_1.js"></script>
	...
	<div class="u_set_cnt clearfix">
	    ...
	    <ul class="fontSong">
	        ...
	        <ul>
	        <li data-bn-ipg="usercenter-setting-bind"  class="current">
	    ...
	    <div class="u_set_main">
	    	...
	    	<div class="u_set_title">
	        	<strong class="text fontYaHei">账号安全</strong>
	     	</div>
	        <!--设置模块栏目内容 -->
	     	 <div class="u_set_account">
            <p class="u_set_account_text">绑定手机邮箱，提升账号安全</p>
            <div class="u_set_account_cont u_set_account_email">
                <span class="label">邮箱</span>
                <div class="base">
                    <a class="bind_email" data-bn-ipg="usercenter-setbind-email-bind" href=" ">立即绑定</a>
                </div>
            </div>
            <div class="u_set_account_cont u_set_account_phone">
                <span class="label">手机</span>
                <div class="base">
                    <span class="user_phone">{{ $user -> phone }}</span>
                    <a class="update_phone" data-bn-ipg="usercenter-setbind-mobile-change" href="">修改手机号</a>
                    <a class="unbind_phone" data-bn-ipg="usercenter-setbind-mobile-unbind" data-bind-mail="" href="javascript:;">解绑</a>
                </div>
            </div>
        </div>
        <!--设置模块栏目标题 -->
        <div class="u_set_title u_set_auth_title">
            <strong class="text fontYaHei">第三方绑定</strong>
        </div>
        <div class="u_set_auth_subtitle">第三方账号绑定，与小伙伴一起分享旅行乐趣</div>
        <!--设置模块栏目内容 -->
        <div class="u_set_bind">
            <!--绑定列表 -->
            <div class="list clearfix">
                <img src="//static.qyer.com/images/user2/seting/bind_sina.gif" width="48" height="48" alt="" class="fl">
                <div class="text">新浪微博绑定账户</div>
                    <a data-bn-ipg="usercenter-setbind-sina" href=" " class="btn ui_buttonB">现在绑定</a>
                </div>
            <!--分隔线 -->
            <div class="border"></div>
            <div class="list clearfix">
                <img src="//static.qyer.com/images/user2/seting/bind_qq.gif" width="48" height="48" alt="" class="fl">
                <div class="text">腾讯QQ绑定账户</div>
                    <a data-bn-ipg="usercenter-setbind-qq" href=" " class="btn ui_buttonB">现在绑定</a>
                </div>
            <div class="border"></div>
            <div class="list clearfix">
                <img src="//static.qyer.com/images/user2/seting/bind_taobao.png" width="48" height="48" alt="" class="fl">
                <div class="text">淘宝账号绑定账户</div>
                    <a data-bn-ipg="usercenter-setbind-tao" href=" " class="btn ui_buttonB">现在绑定</a>
                </div>
            <!--分隔线 -->
            <div class="border"></div>
            <div class="list clearfix">
                <img src="//static.qyer.com/images/user2/seting/bind_wechat.png" width="48" height="48" alt="" class="fl">
                <div class="text">腾讯微信绑定账户</div>
                    <a data-bn-ipg="usercenter-setbind-qq" href=" " class="btn ui_buttonB">现在绑定</a>
                </div>
        </div>
