  ...
  <div class="u_set_cnt clearfix">
    <!--设置模块导航 -->
      ...
      <ul class="fontSong">
          ...
          <li data-bn-ipg="usercenter-setting-subscribe"  class="current">
      ...
      <div class="u_set_main">
          ...
          <div class="u_set_title">
              <strong class="text fontYaHei">修改背景</strong>
          </div>
            <!--设置模块栏目内容 -->
   <div class="u_set_face">
          <form class="mws-form" action="/home/geren/{{ $user -> id }}/updatebeijingpic" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
            <div class="default">
              <div class="face">
                <img src="
                @if(!empty($user -> Usersdetail -> beijingpic)) {{ $user -> Usersdetail -> beijingpic }} @else /home/beijingpic/morenbeijing.png @endif"
                style="width: 400px;height: 200px;border-radius: 0"  id='show' alt="" />
              </div>
              <div id="addAvatarWrap" class="select clearfix" style="position: relative;">
                <input type="file" id='file' name="beijingpic" value="" onchange="c()">
