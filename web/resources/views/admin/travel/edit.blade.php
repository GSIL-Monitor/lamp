...
@endif
 ...
 <div class="mws-panel">
    ...
    <div class="mws-panel-header">
        <span><i class="icon-calculate"></i>美食推荐</span>
    </div>
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/travel/{{ $data['id'] }}" method="post" enctype="multipart/form-data">
        	{{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="large" value="{{ $data['tag'] }}" name="tag">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">时长</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" value="{{ $data['day'] }}" name="day">
                    </div>
                </div>
                <div class="mws-form-row">
