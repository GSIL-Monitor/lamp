...
@endif
 ...
 <div class="mws-panel">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/travel" method="post" enctype="multipart/form-data">
        	{{ csrf_field() }}
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="large" name="tag">
                    </div>
                </div>
                <div class="mws-form-row">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="large" name="day">
                    </div>
                </div>
            	<div class="mws-form-row">
