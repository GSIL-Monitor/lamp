...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/job" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label" >标题名称</label>
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="jtitle" value="{{ old('jtitle') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label" >联系电话</label>
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="jphone" value="{{ old('jphone') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label" >广告链接网址</label>
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="jhttp" value="{{ old('jhttp') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                  <label class="mws-form-label">上传广告小图片</label>
                  <div class="mws-form-item" style="width:670px;">
                      <input type="file" name="jpice"  class="medium" placeholder="111" value="{{ old('jpice') }}">
                  </div>
