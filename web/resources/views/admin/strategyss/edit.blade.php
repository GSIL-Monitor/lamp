...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/strategyss/{{ $strategyss->id }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
...
&nbsp;&nbsp;&nbsp;&nbsp;<select  style="width:200px;" name="stitle" >
                            <option value="{{ $strategyss->stitle }}" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $strategyss->stitle }}</font></font></option>
                ...
                <div class="mws-form-row dd1" style="width:360px;float: left;" >
                    ...
                    <div class="mws-form-item" style="width:300px;">
                        <input type="text" class="medium" name="smdd" value="{{ $strategyss->smdd }}">
                    </div>
                </div>
                
                 <div style="line-height:65px;margin-left:450px;">
                   <label style="font-size: 10px;">评分值:</label>
                      <input type="text" name="pdcaas" value="{{ $strategyss->pdcaas }}" style="width:100px;">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" style="width:700px;">
                        <input type="text" class="medium" name="shttps" value="{{ $strategyss->shttps }}">
                    </div>
                </div>
                <div class="mws-form-row">
                  <label class="mws-form-label">景色图片</label>
                  <div class="mws-form-item" style="width:670px;">
                      <input type="file" name="spice"  class="medium"  placeholder="{{ old('spice') }}" value="{{ $strategyss->spice }}">
                      <div style="width:150px;height:150px;" >
                        <img src="{{ $strategyss->spice }}" alt="" >
                      </div>
                  </div>
