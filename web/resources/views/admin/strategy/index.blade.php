  ...
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
      <div id="DataTables_Table_1_length" class="dataTables_length">
        <form action="/admin/strategy" method="get">
            <label>显示
        ...
        <form action="/admin/strategy" method="get" style="float: right;padding-right: 25px;">
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all" align="center">
       @foreach($strategy as $k=>$v)
        <tr class="odd">
            ...
            <td >
               <a href="/admin/strategy/{{ $v->id }}/edit" class="btn btn-success">修改</a>
                <form action="/admin/strategy/{{ $v->id }}" method="post" style="display: inline;">
                  {{ csrf_field() }}
                  {{ method_field('DELETE') }}
    ...
    <div id="page_page">
       {!! $strategy->appends([$request])->render() !!}
    </div>
  </div>
</div>
</div>
