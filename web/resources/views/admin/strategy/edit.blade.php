...
@endif
 ...
 <div class="mws-panel">
    ...
    <div class="mws-panel-header">
        <span><i class="icon-calculate"></i>城市攻略</span>
    </div>
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/strategy/{{ $data['id'] }}" method="post" enctype="multipart/form-data">
        	{{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="mws-form-inline">
            	...
            	<div class="mws-form-row">
                	...
                	<div class="mws-form-item">
                        <tr class="odd">
                            <td><img src="{{ $data['picture'] }}" width="100px"></td>
                        </tr>
